        ...
        <div class="col-12">
            <div class="card my-4">
                <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
                    <div class="bg-gradient-primary shadow-primary border-radius-lg pt-4 pb-3">
                        <div class="d-flex justify-content-between">
                            <h6 class="text-white text-capitalize ps-3">Add Chef</h6>
                        </div>
                    </div>
                </div>
                ...
                <div class="card-body px-4 pb-2">
                    <form action="{{ route('panel.chef.store') }}" method="post" class="p-3"
                            ...
                            <div class="col-md-6">
                                <div class="form-group mb-3">
                                    ...
                                    <input type="url"
                                        ...
                                        value="{{ old('fb_link') }}" name="fb_link" id="fb_link"
                            ...
                            <div class="col-md-6">
                                <div class="form-group mb-3">
                                    ...
                                    <select name="position" id="position" class="form-select border ps-2 pe-4 @error('position') is-invalid @enderror">
                                        ...
                                        <option value="Barista" {{ old('position') == 'Barista' ? 'selected' : '' }}>Barista</option>
                                        ...
                                        <option value="Owner" {{ old('position') == 'Manager' ? 'selected' : '' }}>Manager</option>
                            ...
                            <div class="col-md-6">
                                <div class="form-group mb-3">
                                    ...
                                    <input type="url"
                                        ...
                                        value="{{ old('insta_link') }}" name="insta_link" id="insta_link"
